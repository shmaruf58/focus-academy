...
const Category = () => {
  return (
    <section>
      <h1 className="text-5xl font-bold text-center">Most Famous Photography</h1>
      <Swiper
        slidesPerView={4}
        spaceBetween={30}
      ...
      >
        <SwiperSlide>
          {" "}
          <img src={slide1} alt="" />
          <h3 className="text-white  md:ps-20 ps-1 md:-mt-16 -mt-8 uppercase md:text-4xl text-xl">
